...
const notInFirstArray = (forbiddenValues, arr) => {
  return arr.filter(function (notIn) {
    return !forbiddenValues.includes(notIn);
  })
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  return arr.filter(function (skill) {
    return skill.baseStat > minBaseStat;
  });
};
